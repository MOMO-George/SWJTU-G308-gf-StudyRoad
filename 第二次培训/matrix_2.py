...
class DataAugmentForObjectDetection():
    ...
    def _addNoise(self, img):
        ...
        np.random.seed(int(time.time()))  # 在调用random_noise前设置
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_img_path', type=str, default='img2')
    parser.add_argument('--save_xml_path', type=str, default='xml2')
